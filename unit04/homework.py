...
# Question 4: The "cluster names" for each transaction is stored in the "name" key. Print the unique clusters from the data file, besides OKX.com and besides the empty string "".
